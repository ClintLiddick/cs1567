...
(cl:defmethod cl:initialize-instance :after ((m <ConstantCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConstantCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cs1567p0-srv:<ConstantCommand-request> is deprecated: use cs1567p0-srv:ConstantCommand-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <ConstantCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p0-srv:cmd-val is deprecated.  Use cs1567p0-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConstantCommand-request>)))
  ...
  "cs1567p0/ConstantCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConstantCommand-request)))
  "Returns string type for a service object of type 'ConstantCommand-request"
  "cs1567p0/ConstantCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ConstantCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConstantCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cs1567p0-srv:<ConstantCommand-response> is deprecated: use cs1567p0-srv:ConstantCommand-response instead.")))

(cl:ensure-generic-function 'ok-val :lambda-list '(m))
(cl:defmethod ok-val ((m <ConstantCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cs1567p0-srv:ok-val is deprecated.  Use cs1567p0-srv:ok instead.")
  (ok m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConstantCommand-response>)))
  ...
  "cs1567p0/ConstantCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConstantCommand-response)))
  "Returns string type for a service object of type 'ConstantCommand-response"
  "cs1567p0/ConstantCommandResponse")
